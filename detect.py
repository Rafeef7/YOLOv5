...
def parse_opt():
    ...
    parser.add_argument('--save-txt', default=ROOT/ 'runs/detect', help='save results to *.txt')
...
def main(opt):
    ...
    run(**vars(opt))
    res = detection(r"C:\Users\C-ROAD\Desktop\yolov5\runs\detect\exp\labels\image.txt")
    shutil.rmtree(r"C:\Users\C-ROAD\Desktop\yolov5\runs\detect\exp")
    return res
